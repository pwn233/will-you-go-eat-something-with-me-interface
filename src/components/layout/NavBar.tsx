  ...
  return (
    <div className="bg-primary-400 sticky top-0 z-20 flex h-[var(--header-height)] w-full flex-row items-center justify-between gap-x-10 px-3">
      <a
        ...
        className="text-heading-4 hover:text-secondary-700 hidden cursor-pointer text-black sm:block"
      >
        🩷 Will you go eating something with me ?
      </a>
      <a
        href={import.meta.env.BASE_URL}
        className="text-heading-4 hover:text-secondary-700 block cursor-pointer text-black sm:hidden"
      >
        🩷
      </a>
