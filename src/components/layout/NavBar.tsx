...
export const NavBar = () => {
  ...
  return (
    <div className="bg-primary-400 sticky top-0 z-20 flex h-[var(--header-height)] w-full flex-row items-center justify-between gap-x-10 px-3">
      <a href="/" className="text-heading-4 hover:text-secondary-700 hidden text-black sm:block">
        🩷 Will you go eating something with me ?
      </a>
      <a href="/" className="text-heading-4 hover:text-secondary-700 block text-black sm:hidden">
        🩷
      </a>
